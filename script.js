document.addEventListener("DOMContentLoaded",()=>{
  ...
  const modal=document.querySelector("#training-modal"),title=document.querySelector("#modal-title"),summary=document.querySelector("#modal-summary"),content=document.querySelector("#modal-body"),closeButton=document.querySelector(".modal-close");let previousFocus=null;
